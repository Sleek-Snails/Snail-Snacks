...
pygame.font.init()
assets = "puzzle2assets"
WIDTH, HEIGHT = 800, 750
WIN = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("Space Invaders made by Coal")
...
class Laser:
    ...
    def draw(self, window: pygame.display.set_mode) -> None:
        """Here"""
...
class Ship:
    ...
    def move_lasers(self, vel: int, obj: list) -> None:
        """Here"""
        self.cooldown()
        for laser in self.lasers:
            laser.move(vel)
...
class Player(Ship):
    ...
    def healthbar(self, window: pygame.display.set_mode) -> None:
        """Here"""
...
def collide(obj1: Enemy, obj2: Player) -> bool:
    """Here"""
